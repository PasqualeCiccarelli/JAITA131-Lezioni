...
public class Macchina {
	...
	//relazione bidimnensionale: in java se cerco una macchina e poi richiamno getUtente
	...
	@JsonIgnore
	@ManyToOne
	@JoinColumn(name = "utente_id", nullable = false)//name e il nome della chiave esterna presente nella tabella macchine 
